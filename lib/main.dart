...
class MyApp extends StatelessWidget {
  final List<Fruit> fruits = [
    ...
    Fruit('Citron Vert', Colors.greenAccent, 3.38, 0,
        '../lib/assets/citron-vert.png'),
    Fruit('Fraise', Colors.red, 5.99, 0, '../lib/assets/fraise.png'),
    Fruit(
        'Framboise', Colors.redAccent, 2.50, 0, '../lib/assets/framboise.png'),
    Fruit('Fruit de la Passion', Colors.purple.shade900, 14.00, 0,
        '../lib/assets/fruit-de-la-passion.png'),
    ...
    Fruit('Myrtille', Colors.purple.shade900, 1.70, 0,
        '../lib/assets/myrtille.png'),
    Fruit('Orange', Colors.orange, 1.35, 0, '../lib/assets/orange.png'),
    Fruit(
        'Pastèque', Colors.greenAccent, 4.99, 0, '../lib/assets/pasteque.png'),
    Fruit('Pêche', Colors.orangeAccent, 2.99, 0, '../lib/assets/peche.png'),
    Fruit('Poire', Colors.green, 1.48, 0, '../lib/assets/poire.png'),
    Fruit(
        'Pomelo', Colors.orange.shade400, 0.70, 0, '../lib/assets/pomelo.png'),
